...
class im2gps3kDataset(VisionDataset):
    def __init__(self, root_path='./data', text_data_path='im2gps3k_places365.csv', image_data_path='im2gps3ktest/', vision_processor= None, text_processor=None):
        super().__init__(self)
...
class yfcc4kDataset(VisionDataset):
    def __init__(self, root_path='./data', text_data_path='yfcc4k_places365.csv', image_data_path='yfcc4k/yfcc4k/', vision_processor= None, text_processor=None):
        super().__init__(self)
